    ...
    <div className="project-detail">
      ...
      <div className="project-detail-content">
        ...
        <div className={`project-detail-image-container project-glow-${project.id} ${project.id === 4 ? 'aeon-detail' : ''} ${project.id === 1 ? 'wat-detail' : ''} ${project.id === 5 ? 'gradepad-detail' : ''} ${project.id === 7 ? 'shopify-detail' : ''} ${project.id === 2 ? 'qquote-detail' : ''} ${project.id === 3 ? 'encore-detail' : ''}`}>
          <img
            src={project.id === 7 ? './images/ShopifyLaptop.webp' : project.id === 2 ? './images/QQuoteLaptop.webp' : project.id === 1 ? './images/WataiMonitor.webp' : project.id === 3 ? './images/EncoreDesk.webp' :project.id === 4 ? './images/AeonPhones.webp' : project.id === 5 ? './images/GradePadbgPP (3).webp' : project.image}
            alt={project.title}
